...
module.exports = {
  ...
  site: {
    ...
    baseUrl: '/admin/', //process.env.ME_CONFIG_SITE_BASEURL || '/admin/',
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || 'to-hutohu',
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || '19971124',
  },
